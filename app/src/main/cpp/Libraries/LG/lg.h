...
#else
extern asm void *memset(void *dest, int val, unsigned int count);
extern asm void *memcpy(void *dest, const void *src, unsigned int count);
extern asm void *memmove(void *dest, const void *src, unsigned int count);
#endif
