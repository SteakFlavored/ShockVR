...
extern void flat8_set_upixel (int32_t color, int16_t x, int16_t y);
extern int32_t flat8_set_pixel (int32_t color, int16_t x, int16_t y);
extern int32_t flat8_get_upixel (int16_t x, int16_t y);
extern int32_t flat8_get_pixel (int16_t x, int16_t y);

/* 24-bit pixel prototypes. */
extern void flat8_set_upixel24 (int32_t color, int16_t x, int16_t y);
extern int32_t flat8_set_pixel24 (int32_t color, int16_t x, int16_t y);
extern int32_t flat8_get_upixel24 (int16_t x, int16_t y);
...
extern void flat8_uvline (int16_t x0, int16_t y0, int16_t y1);
extern void flat8_urect (int16_t left, int16_t top, int16_t right, int16_t bot);
...
extern void flat8_upoly(int32_t c,int32_t n,grs_vertex **vpl);
extern void flat8_uspoly(int32_t c, int32_t n, grs_vertex **vpl);
extern void flat8_ucpoly(int32_t c, int32_t n, grs_vertex **vpl);
extern void flat8_interp2_ubitmap(grs_bitmap *bm);
extern void flat8_filter2_ubitmap(grs_bitmap *bm);
extern void flat8_tluc8_upoly(int32_t c, int32_t n,grs_vertex **vpl);
extern void flat8_tluc8_uspoly(int32_t c, int32_t n,grs_vertex **vpl);
...
extern int32_t flat8_flat8_per_umap
    (grs_bitmap *bm, int32_t n, grs_vertex **vpl);
extern int32_t flat8_flat8_lit_per_umap
    (grs_bitmap *bm, int32_t n, grs_vertex **vpl);
extern int32_t flat8_flat8_clut_per_umap
    (grs_bitmap *bm, int32_t n, grs_vertex **vpl, uint8_t *cl);
extern int32_t flat8_flat8_solid_per_umap
    (grs_bitmap *bm, int32_t n, grs_vertex **vpl, int32_t c);

extern void flat8_lin_lit_utmap (int32_t n, fix *vlist, grs_bitmap *bm, fix *m, fix *l);

extern void flat8_scale_ubitmap (grs_bitmap *bm, int16_t x, int16_t y,
    int16_t w, int16_t h);
extern int32_t flat8_scale_bitmap (grs_bitmap *bm, int16_t x, int16_t y,
    int16_t w, int16_t h);


extern void flat8_mono_scale_ubitmap (grs_bitmap *bm, int16_t x, int16_t y,
    int16_t w, int16_t h);
extern int32_t flat8_mono_scale_bitmap (grs_bitmap *bm, int16_t x, int16_t y,
    int16_t w, int16_t h);

extern void flat8_rsd8_scale_ubitmap (grs_bitmap *bm, int16_t x, int16_t y,
    int16_t w, int16_t h);
extern int32_t flat8_rsd8_scale_bitmap (grs_bitmap *bm, int16_t x, int16_t y,
    int16_t w, int16_t h);
...
extern void flat8_rsd8_clut_scale_ubitmap
    (grs_bitmap *bm, int16_t x, int16_t y, int16_t w, int16_t h, uint8_t *cl);
extern int32_t flat8_rsd8_clut_scale_bitmap
    (grs_bitmap *bm, int16_t x, int16_t y, int16_t w, int16_t h, uint8_t *cl);

extern void flat8_rsd8_scale_solid_ubitmap
    (grs_bitmap *bm, int16_t x, int16_t y, int16_t w, int16_t h, int32_t c);
extern int32_t flat8_rsd8_scale_solid_bitmap
    (grs_bitmap *bm, int16_t x, int16_t y, int16_t w, int16_t h, int32_t c);

extern void flat8_tluc8_scale_ubitmap (grs_bitmap *bm, int16_t x, int16_t y,
    int16_t w, int16_t h);
extern int32_t flat8_tluc8_scale_bitmap (grs_bitmap *bm, int16_t x, int16_t y,
    int16_t w, int16_t h);

extern void flat8_tluc8_clut_scale_ubitmap (grs_bitmap *bm, int16_t x, int16_t y,
    int16_t w, int16_t h, uint8_t *cl);
extern int32_t flat8_tluc8_clut_scale_bitmap (grs_bitmap *bm, int16_t x, int16_t y,
    int16_t w, int16_t h, uint8_t *cl);

// internal scaler/mapper prototypes
int32_t gri_opaque_solid_scale_umap_init(grs_tmap_loop_info *info, grs_vertex **vert);
int32_t gri_trans_scale_umap_init(grs_tmap_loop_info *, grs_vertex **);
int32_t gri_trans_solid_scale_umap_init(grs_tmap_loop_info *info, grs_vertex **vert);
...
extern void flat8_flat8_clut_ubitmap (grs_bitmap *bm, int16_t x, int16_t y, uint8_t *cl);

extern void flat8_rsd8_solid_ubitmap (grs_bitmap *bm, int16_t x, int16_t y, int32_t c);
extern int32_t flat8_rsd8_solid_bitmap (grs_bitmap *bm, int16_t x, int16_t y, int32_t c);

/* bitmap get routines. */
extern void flat8_get_flat8_ubitmap (grs_bitmap *bm, int16_t x, int16_t y);

/* bitmap horizontal flip routines. */
extern void flat8_hflip_flat8_ubitmap (grs_bitmap *bm, int16_t x, int16_t y);

/* bitmap color lookup table horizontal flip routines. */
extern void flat8_clut_hflip_flat8_ubitmap (grs_bitmap *bm, int16_t x, int16_t y, uint8_t *cl);

/* device-specific routines. */
extern int16_t flat8_calc_row (int16_t w);
extern grs_bitmap *flat8_sub_bitmap (grs_bitmap *bm, int16_t x, int16_t y,
    int16_t w, int16_t h);
