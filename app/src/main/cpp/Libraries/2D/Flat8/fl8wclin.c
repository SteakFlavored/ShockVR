...
void gri_flat8_wire_poly_ucline_norm(int32_t c, uintptr_t parm, grs_vertex *v0, grs_vertex *v1) {
    #include "fl8wclin.h"
}
...
void gri_flat8_wire_poly_ucline_clut(int32_t c, uintptr_t parm, grs_vertex *v0, grs_vertex *v1) {
