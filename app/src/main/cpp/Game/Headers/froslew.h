...
int32_t *fr_objslew_obj_to_fix(int32_t *flist, Obj *cobj, int32_t count);
Obj  *fr_objslew_fix_to_obj(int32_t *flist, Obj *cobj, int32_t count);
bool  fr_objslew_tele_to(Obj *cobj, int32_t x, int32_t y);
bool  fr_objslew_allowed(Obj *cobj, int32_t *eye);
bool  fr_objslew_moveone(Obj *objp, ObjID objnum, int32_t which, int32_t how, bool conform);
