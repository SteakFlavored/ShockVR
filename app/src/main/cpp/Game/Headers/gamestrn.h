...
char* get_object_short_name(int32_t triple, char* buf, int32_t bufsize);
char* get_object_long_name(int32_t triple, char* buf, int32_t bufsize);
char* get_alloc_string(int32_t num);
